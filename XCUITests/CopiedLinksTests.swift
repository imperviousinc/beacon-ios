...
class CopiedLinksTests: BaseTestCase {
    ...
    func testCopiedLinks() {
        ...
        let value = app.tables.cells.switches["Offer to Open Copied Links, When Opening Beacon"].value
        XCTAssertEqual(value as? String, "0")

        //Switch on, Offer to open copied links, when opening firefox
        app.tables.cells.switches["Offer to Open Copied Links, When Opening Beacon"].tap()

        //Check Offer to open copied links, when opening firefox is on
        let value2 = app.tables.cells.switches["Offer to Open Copied Links, When Opening Beacon"].value
        ...
        //Check Offer to open copied links, when opening firefox is on
        let value3 = app.tables.cells.switches["Offer to Open Copied Links, When Opening Beacon"].value
